...
export namespace NameList {
  ...
  export const CATEGORY = 'NameList';
  ...
  export const ActionTypes: INameListActions = {
    ...
    FORMS_INIT:  type(`${CATEGORY} Forms Init`),
    FORMS_INITIALIZED: type(`${CATEGORY} Forms Initialized`)
  };
  ...
  export class FormsInitAction implements Action {
    type = ActionTypes.FORMS_INIT;
    payload: string = null;
  }

  export class FormsInitializedAction implements Action {
    type = ActionTypes.FORMS_INITIALIZED;
